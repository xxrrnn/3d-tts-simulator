...
setup_logger(root_dir, "run_Attn_seqparal") 
logger = logging.getLogger(__name__)



def main_for_Attn_seqparal():
    logger.info("Attn序列并行模型运行开始")
    ...
    # 运行Attn基线模型
    total_latency, total_energy_consumption = run_Attn_seqparal(
...
if __name__ == "__main__":
    total_latency, total_energy_consumption = main_for_Attn_seqparal()    
    with open ("/DISK1/data/zczhou_23/work2/Simulator_V3/results/energy/attn_seqparal.txt", "w") as f:
