...
def main_for_Attn_baseline2():
    ...
    my_dram_config = DRAM_config(
        ...
        bandwidth=696/64,  #GB/s  GDDR6X  对齐到3090Ti
    ...
    # 运行Attn基线模型
    total_latency = run_Attn_baseline2(
...
if __name__ == "__main__":
    total_latency = main_for_Attn_baseline2() 

    with open ("/DISK1/data/zczhou_23/work2/Simulator_V3/results/attn_2D_baseline.txt", "w") as f:
