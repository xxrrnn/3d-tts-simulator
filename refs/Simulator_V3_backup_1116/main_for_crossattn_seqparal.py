...
from src import CrossAttn_Layer_SeqParal
...
setup_logger(root_dir, "run_CrossAttn_seqparal") 
logger = logging.getLogger(__name__)



def main_for_CrossAttn_seqparal():
    logger.info("CrossAttn序列并行模型运行开始")
    ...
    # 设置Attn层的N，并初始化矩阵
    my_attn_layer.set_N(my_input1_token_num, my_input2_token_num)
    my_attn_layer.init_matrices()

    
    # 运行Attn基线模型
    run_CrossAttn_seqparal(
